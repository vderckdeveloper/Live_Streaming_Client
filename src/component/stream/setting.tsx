...
function Setting({ isCurrentScreenOff, onShareMyCurrentScreen, onStartRecordingScreen, onStopRecordingScreen, refs }: ScreenProps) {
                    ...
                    <div className={styles['middle-setting-bar']}>
                        ...
                        {/* screen record button */}
                        {
                            isScreenRecordingOff
                                ?
                                <div className={styles['svg-box']} onClick={() => {
                                ...
                                :
                                <div className={styles['screen-record-svg-box']} onClick={() => {
                                    onStopRecordingScreen();
                                    onToggleRecording();
                                }}>
