"use client";
import { useMainBody } from './useMainBody';  
import styles from '@/component/main/mainbody/mainBody.module.css';

function MainBody() {
    const { code, onCode, onStart, onJoin, onJoinEnter } = useMainBody();  
            ...
            <div className={styles['wrapper']}>
                ...
                <div className={styles['stream']}>
                    ...
                    <div className={styles['type']} >
                        ...
                        <input type='text' maxLength={12} placeholder='참여 코드를 입력하세요.' value={code} onChange={onCode} onKeyDown={onJoinEnter}/>
                    </div>
